...
以下截图展示了社区版工作台的演示数据流程。

| 系统总览 | 识别任务 |
|---|---|
| ![系统总览](docs/assets/screenshots/01-system-overview.png) | ![识别任务](docs/assets/screenshots/02-recognition-task.png) |

| 文档树 | 精准定位 |
|---|---|
| ![文档树](docs/assets/screenshots/03-document-tree.png) | ![精准定位](docs/assets/screenshots/04-precise-location.png) |

| 数据抽取 |
|---|
| ![数据抽取](docs/assets/screenshots/05-data-extraction.png) |
...
原创归属与品牌使用说明请见 [NOTICE](NOTICE)、[AUTHORS](AUTHORS) 和
