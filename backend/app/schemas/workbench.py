...
class SkillSampleLocateCandidate(BaseModel):
    ...
    matchedWindows: list[dict[str, Any]] = Field(default_factory=list)
    rowWindow: Optional[dict[str, Any]] = None
    shapeSignals: dict[str, Any] = Field(default_factory=dict)
    uncertainties: list[str] = Field(default_factory=list)
    deterministicScore: Optional[float] = None
